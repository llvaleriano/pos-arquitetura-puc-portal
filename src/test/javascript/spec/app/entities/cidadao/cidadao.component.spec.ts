...
import { CidadaoComponent } from 'app/entities/cidadao/cidadao.component';
import { CidadaoService } from 'app/entities/cidadao/cidadao.service';
import { Cidadao } from 'app/shared/model/cidadao.model';

describe('Component Tests', () => {
  describe('Cidadao Management Component', () => {
    let comp: CidadaoComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CidadaoComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.cidadaos && comp.cidadaos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
